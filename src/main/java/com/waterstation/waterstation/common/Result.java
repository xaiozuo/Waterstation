...
public class Result {
    ...
    public static Result setMessageData(String code, String msg, Object data){
    ...
    public static Result success(String msg){return setMessageData("0", msg, null);}
    ...
    public static Result fail(String code,String msg, Object data){
        return setMessageData(code, msg, data);
    }
