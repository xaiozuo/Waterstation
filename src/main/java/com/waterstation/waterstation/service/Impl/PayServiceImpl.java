...
public class PayServiceImpl implements PayService {
    ...
    @Override
    @Transactional
    public Map insertPayRecord(String SpbillCreateIp,String Openid,double value) {
        //接收返回的参数
        ...
        try {
            ...
            //weChatPay.setApi_key(payProperties.getApiKey());
...
//            weChatPay.setSpbill_create_ip("127.0.0.1");
            weChatPay.setSpbill_create_ip(SpbillCreateIp);
...
//            weChatPay.setOpenid("oOKq*******xj8o");
            ...
            // 处理类上的注解
            xStream.processAnnotations(OrderReturnInfo.class);
    ...
    public Map orderQuery(String out_trade_no){
        ...
        try {
            ...
            // 处理类上的注解
            xStream.processAnnotations(QueryReturnInfo.class);
     ...
     */
    @Override
    public Map insertPayRefund(String SpbillCreateIp,String Openid,double value){
        Map<String, Object> map = new HashMap<>();
        String title = "test";
        //金额 * 100 以分为单位
        BigDecimal fee = BigDecimal.valueOf(value);
...
//            weChatPay.setSpbill_create_ip("127.0.0.1");
            ...
            String result = HttpRequest.sendPost(WeChatPayUrlConstants.Refund, weChatPay);
            System.out.println(weChatPay);
            System.out.println(result);
